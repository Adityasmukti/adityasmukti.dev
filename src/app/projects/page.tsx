        ...
        <div className="container">
          <div className="border-x border-primary/10 px-4 sm:px-7">
            ...
            <div className="flex flex-col gap-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">{t('projects.all.title')}</h1>
              <p className="text-secondary max-w-2xl text-lg">
                {t('projects.all.description')}
              </p>
            </div>
          </div>
        </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {project.tech.slice(0, 4).map((techItem) => (
                          <span key={techItem} className="text-[10px] px-2 py-0.5 bg-primary/5 rounded-md text-primary/70 border border-primary/10">
                            {techItem}
                          </span>
                        ))}
